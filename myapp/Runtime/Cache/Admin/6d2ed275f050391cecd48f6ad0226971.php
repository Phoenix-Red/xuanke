...
<body id="page">
<h2>修改课程</h2>
<form action="__URL__/updateCourseInfo/id/<?php echo ($course_info["id"]); ?>" method="post" name="myform" onsubmit="return check();">
<table>
  <tr><th>课程编号</th><th>课程名</th><th>已选人数</th><th>课容量</th>  
 <th>上课教室</th><th>上课时间</th><th>学分</th></tr>
  <tr>
    ...
    <!-- <td><input type="text" name="teacher_name" value="<?php echo ($course_info["teacher_name"]); ?>"></td> -->
    <td><input type="text" name="selectedMan" value="<?php echo ($course_info["selectedMan"]); ?>"></td>
